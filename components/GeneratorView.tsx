...
interface GeneratorViewProps {
  ...
  onBetsGenerated: (bets: number[][], mode: GenerationMode) => void;
}
...
export const GeneratorView: React.FC<GeneratorViewProps> = ({ analysisData, onBetsGenerated }) => {
  ...
  }, [analysisData, numGames, mode, onBetsGenerated]);
  ...
  return (
    <div className="space-y-6">
      <div className="bg-gray-900 p-4 rounded-lg space-y-4 md:flex md:items-center md:justify-between md:space-y-0">
        <div className="flex items-center gap-4">
          <label htmlFor="numGames" className="font-semibold whitespace-nowrap">Qtd. Jogos (1-100):</label>
          <input
            type="number"
            id="numGames"
            min="1"
            ...
            className="bg-gray-700 border border-gray-600 rounded-md p-2 w-24 text-center focus:ring-2 focus:ring-emerald-500 focus:outline-none"
          />
        </div>
